...
//     try {
//       const response = await fetch("https://cute-puce-xerus.cyclic.app/api/liveGameHistory");
...
const LiveHistory = () => {
  ...
  const fetchLiveGameUsers = async (page) => {
    try {
      ...
      const response = await fetch(`https://cute-puce-xerus.cyclic.app/api/liveGameHistory?page=${page}&perPage=10`);
      const data = await response.json();
