...
//     try {
//       const response = await fetch("https://mlm-psi.vercel.app/api/liveGameHistory");
...
const LiveHistory = () => {
  ...
  const fetchLiveGameUsers = async (page) => {
    try {
      ...
      const response = await fetch(`https://mlm-psi.vercel.app/api/liveGameHistory?page=${page}&perPage=10`);
      const data = await response.json();
