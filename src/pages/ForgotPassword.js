...
function ForgotPassword() {
  ...
  const handleEmailSubmit = async (event) => {
    ...
    try {
      await axios.post('https://mlm-psi.vercel.app/api/auth/forgot-password', { email });
      setIsEmailSent(true);
  ...
  const handleOtpSubmit = async (event) => {
    ...
    try {
      await axios.post('https://mlm-psi.vercel.app/api/auth/reset-password', { email, otp, newPassword });
