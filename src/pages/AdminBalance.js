...
function AdminBalance() {
  ...
  const searchUser = async () => {
    try {
      const response = await axios.get(`https://cute-puce-xerus.cyclic.app/api/game/balance/${userId}`);
  ...
  const updateBalance = async () => {
    try {
      ...
      await axios.put(`https://cute-puce-xerus.cyclic.app/api/game/balance/${userId}`, { balance });
