...
function AdminBalance() {
  ...
  const searchUser = async () => {
    try {
      const response = await axios.get(`https://mlm-psi.vercel.app/api/game/balance/${userId}`);
  ...
  const updateBalance = async () => {
    try {
      ...
      await axios.put(`https://mlm-psi.vercel.app/api/game/balance/${userId}`, { balance });
