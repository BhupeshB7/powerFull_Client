...
//       try {
//         // const response = await fetch(`https://cute-puce-xerus.cyclic.app/api/daily-level-income/users/${data.userId}`);
//         const response = await fetch(
//           `https://cute-puce-xerus.cyclic.app/api/daily-level-income/users/${data.userId}`,
//           {
//             headers: {
...
//     axios
//       .get(
//         `https://cute-puce-xerus.cyclic.app/api/users/teamStructureRank/${data.userId}`
//       )
//       .then((response) => {
...
//     axios
//       .get(
//         `https://cute-puce-xerus.cyclic.app/api/users/teamStructure/${data.userId}`
//       )
//       .then((response) => {
...
//           `https://cute-puce-xerus.cyclic.app/api/users/team/${userId}`
//         );
...
//       try {
//         const response = await axios.get(
//           `https://cute-puce-xerus.cyclic.app/api/deposit/topUpuserAmount/${userID}`
//         );
...
//       try {
//         const response = await axios.get(
//           `https://cute-puce-xerus.cyclic.app/api/direct/${data.userId}`
//         );
...
//     fetch(`https://cute-puce-xerus.cyclic.app/api/withdraw/${data.userId}`, {
//       method: "POST",
//       headers: {
...
//     try {
//       // const response = await axios.post('https://cute-puce-xerus.cyclic.app/api/deposit/upload', formData);
//       const response = await axios.post(
//         "https://cute-puce-xerus.cyclic.app/api/deposit/user",
//         formData
//       );
//       const data = response.data;
...
//     try {
//       const response = await axios.post(
//         `https://cute-puce-xerus.cyclic.app/api/transfer/${data._id}`,
...
//     try {
//       const response = await fetch(
//         "https://cute-puce-xerus.cyclic.app/api/deposit/topUpActivate/",
//         {
//           method: "POST",
//           headers: {
//             "Content-Type": "application/json",
...
//     try {
//       const response = await fetch(
//         `https://cute-puce-xerus.cyclic.app/api/deposit/topUpUserID/${data.userId}`,
//         {
//           method: "POST",
//           headers: {
//             "Content-Type": "application/json",
...
const Dashboard1 = ({contactInfoList}) => {
  ...
  const handleWithdrawalSubmit = (e) => {
    ...
    const amount = Number(withdrawalAmount); // convert string to number
    fetch(
      `https://cute-puce-xerus.cyclic.app/api/withdraw/user/${data.userId}`,
