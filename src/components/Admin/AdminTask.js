...
const AdminTask = () => {
  ...
  // Delete all task
    const handleDeleteAllTasks = async () => {
      try {
        await axios.delete("https://cute-puce-xerus.cyclic.app/api/tasks");
  ...
  const handleCreateTask = async (values, { resetForm }) => {
    try {
      await axios.post("https://cute-puce-xerus.cyclic.app/api/tasks", values);
  ...
  const fetchTasks = async () => {
    try {
      const response = await axios.get(
        "https://cute-puce-xerus.cyclic.app/api/tasks"
      );
