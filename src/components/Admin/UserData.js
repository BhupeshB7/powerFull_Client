...
//     axios.put(`https://mlm-production.up.railway.app/api/auth/block/${id}`)
//       .then(response => {
...
//     axios.put(`https://mlm-production.up.railway.app/api/auth/unblock/${id}`)
//       .then(response => {
//         setUsers(users.map(user => (user._id === id ? response.data : user)));
//       })
//       .catch(error => console.error(error));
...
function UserData() {
  ...
  //     axios
  //       .put(`https://mlm-production.up.railway.app/api/auth/block/${confirmationUserId}`)
  //       .then((response) => {
