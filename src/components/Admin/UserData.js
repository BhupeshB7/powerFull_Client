...
//     axios
//       .get("https://mlm-psi.vercel.app/api/users/daily-new-users")
//       .then((response) => {
...
//     fetch("https://mlm-psi.vercel.app/api/admin/count-active-items")
...
//   useEffect(() => {
//     fetch("https://mlm-psi.vercel.app/api/admin/users/count")
//       .then((response) => response.json())
...
//         `https://mlm-psi.vercel.app/api/admin/api/users?page=${page}&search=${searchQuery}&itemsPerPage=${itemsPerPage}`
//       );
...
//         `https://mlm-psi.vercel.app/api/active/${userId}/deactivate`
//       );
...
//     try {
//       const response = await axios.patch(
//         `https://mlm-psi.vercel.app/api/active/${userId}/activate`
//       );
//       const updatedUser = response.data;
...
//     await axios.delete(
//       `https://mlm-psi.vercel.app/api/admin/api/users/${id}`
//     );
//     setUsers(users.filter((user) => user._id !== id));
//   };
//   const handleBlock = (id) => {
//     axios.put(`https://mlm-psi.vercel.app/api/auth/block/${id}`)
//       .then(response => {
...
//     axios.put(`https://mlm-psi.vercel.app/api/auth/unblock/${id}`)
//       .then(response => {
//         setUsers(users.map(user => (user._id === id ? response.data : user)));
//       })
//       .catch(error => console.error(error));
...
function UserData() {
  ...
  //     axios
  //       .put(`https://mlm-psi.vercel.app/api/auth/block/${confirmationUserId}`)
  //       .then((response) => {
        ...
        users.map(async (user) => {
          if (user._id === confirmationUserId) {
            const endpoint = user.isBlocked
              ? `https://mlm-psi.vercel.app/api/auth/unblock/${confirmationUserId}`
              : `https://mlm-psi.vercel.app/api/auth/block/${confirmationUserId}`;
