...
const AllFundTransfer = () => {
  ...
  useEffect(() => {
    const fetchAllTransfers = async () => {
      try {
        // const response = await axios.get("https://mlm-psi.vercel.app/api/allTransfers");
        const response = await axios.get("https://mlm-psi.vercel.app/api/allTransfers");
  ...
  const fetchTransferDetail = async () => {
    try {
      const response = await axios.get(
        "https://mlm-psi.vercel.app/api/transferDetail"
      );
  ...
  //     try {
  //       await axios.post(
  //         `https://mlm-psi.vercel.app/api/transfer/approve/${userId}`
  //       );
  ...
  //     try {
  //       await axios.post(
  //         `https://mlm-psi.vercel.app/api/transfer/reject/${userId}`
  //       );
