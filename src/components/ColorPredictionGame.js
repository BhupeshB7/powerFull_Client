...
//     try {
//       const response = await axios.post("https://mlm-psi.vercel.app/api/game/saveGame", gameDetails);
...
const userId = 'PI17218169';
  ...
  const getGamerProfile = async () => {
    try {
      const response = await axios.get(
        `https://mlm-psi.vercel.app/api/gameProfile/${userId}`
      );
  ...
  const handleSubmit = async (e) => {
    e.preventDefault();
    try {
      const response = await fetch("https://mlm-psi.vercel.app/api/depositSubmit", {
        method: "POST",
        headers: {
  ...
  const fetchWithdrawalHistory = async () => {
    try {
      const response = await axios.get(
        `https://mlm-psi.vercel.app/api/history/${userId}`
      );
  ...
  const fetchDepositHistory = async () => {
    try {
      const response = await axios.get(
        `https://mlm-psi.vercel.app/api/deposit/history/${userId}`
      );
...
//     try {
//       const response = await axios.post(
//         "https://mlm-psi.vercel.app/api/game/saveGame",
//         gameDetails
//       );
//       if (response.status === 201) {
//         console.log(gameDetails);
