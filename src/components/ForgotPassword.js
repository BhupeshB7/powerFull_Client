...
const ForgotPassword = () => {
    ...
    const userValid = async () => {
        const res = await fetch(`https://cute-puce-xerus.cyclic.app/api/forgotpassword/${id}/${token}`, {
            method: "GET",
            headers: {
    ...
    const sendpassword = async (e) => {
        ...
        if (password === "") {
            ...
            const res = await fetch(`https://cute-puce-xerus.cyclic.app/api/auth/${id}/${token}`, {
                method: "POST",
                headers: {
                    "Content-Type": "application/json"
                },
